...
export default function Hero() {
  return (
    <section className="relative w-full flex items-center justify-center pt-20 pb-16 px-4 sm:px-6 lg:px-8 min-h-[70vh]">
      {/* Hero Background Image - Centered and Responsive */}
      <div className="relative w-full max-w-6xl mx-auto">
        <div className="relative w-full h-[500px] sm:h-[600px] lg:h-[700px] rounded-lg overflow-hidden shadow-2xl">
          <Image
            src="/lab.jpg"
