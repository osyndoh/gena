  ...
  return (
    <section className="max-w-7xl mx-auto my-8 md:my-12 lg:my-16 text-center">
      ...
      <div className="flex flex-wrap justify-center items-center gap-8 sm:gap-12">
        ...
        <ContactLink
          icon={
            <div className="w-8 h-8 sm:w-10 sm:h-10 text-blue-600 group-hover:text-blue-700 transition-colors duration-200">
              <svg
          ...
          label="Email"
          href="mailto:info@genainitiative.org"
        />

        {/* X (formerly Twitter) Link */}
        <ContactLink
          icon={
            <div className="w-8 h-8 sm:w-10 sm:h-10 text-gray-800 group-hover:text-black transition-colors duration-200">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                className="w-full h-full"
                viewBox="0 0 24 24"
          ...
          label="X"
          href="https://x.com/genainitiative"
          target="_blank"
        ...
        <ContactLink
          icon={
            <div className="w-8 h-8 sm:w-10 sm:h-10 text-blue-700 group-hover:text-blue-800 transition-colors duration-200">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                className="w-full h-full"
                viewBox="0 0 24 24"
          ...
          label="LinkedIn"
          href="https://linkedin.com/company/genainitiative"
          target="_blank"
          rel="noopener noreferrer"
        />
        ...
        <ContactLink
          ...
          label="Facebook"
          href="https://facebook.com/genainitiative"
          target="_blank"
          rel="noopener noreferrer"
        />
      </div>
